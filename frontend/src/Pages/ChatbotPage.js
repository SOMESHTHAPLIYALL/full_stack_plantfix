...
const ChatbotPage = () => {
  ...
  return (
    <>
      <Header />
      <div className="bg-blue-200 min-h-screen flex justify-between p-4">
        <div className="content p-4 ">
          ...
          {loading ? (
            ...
            >
              <div className="flex flex-col items-center gap-10 bg-white p-6 rounded-xl shadow-xl min-h-fit max-h-[500px] w-[600px] overflow-auto  font-semibold">
